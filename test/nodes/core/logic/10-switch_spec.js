...
describe('switch Node', function() {
    ...
    it('should treat non-existant msg property conditional as undefined', function(done) {
        var flow = [{"id":"switchNode1","type":"switch","z":"feee1df.c3263e","name":"","property":"payload","propertyType":"msg","rules":[{"t":"eq","v":"this.does.not.exist","vt":"msg"}],"checkall":"true","outputs":1,"x":190,"y":440,"wires":[[{node: 'helperNode1',port: 0}]]},
            {id:"helperNode1", type:"helper", wires:[]}];
